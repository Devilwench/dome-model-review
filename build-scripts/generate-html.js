...
<div class="sc-card sc-sm" style="border-left:4px solid var(--refuted-border,#c45050)">
...
<div class="sc-card sc-sm" style="border-left:4px solid var(--selfcon-border,#2d8abf)">
...
<div class="sc-card sc-sm" style="border-left:4px solid var(--misleading-border,#c48a30)">
...
<div class="sc-card sc-sm" style="border-left:4px solid var(--std-border,#4a8c4a)">
...
<div class="sc-card sc-sm" style="border-left:4px solid var(--notdemo-border,#7b5eae)">
...
<div class="sc-card sc-sm" style="border-left:4px solid var(--unfals-border,#888)">
...
<tr><td>13</td><td>Solar Wind Pressure</td><td>λ<sub>g</sub></td><td>YES (MHD — fluid dynamics simulations)</td><td>Magnetopause dynamics modeled since the 1960s.</td></tr>
...
<tr><td>16</td><td>Roaring 40s Wind Speed</td><td>Documented since the Age of Sail. Explained by Coriolis + standard atmospheric dynamics (temperature-driven wind patterns).</td></tr>
