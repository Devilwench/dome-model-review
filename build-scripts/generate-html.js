...
<p><strong>Test 1 — Sydney–Perth distance (claimed confirmed):</strong> The dome claims a prediction of 4,352 km. But where does this number come from?</p>

<p><strong>What the dome's own geometry actually predicts:</strong> On a flat disc with the North Pole at center (the azimuthal equidistant projection all flat-earth models use), Sydney sits ~13,773 km from the pole and Perth ~13,560 km. The angular separation is 35.35° of longitude. Applying the law of cosines on the disc gives <strong>~8,300 km</strong> — 2.5× the actual distance. With the author's own Finsler correction for southern hemisphere distances (the scaling factor 1 + 0.35 × lat²/5400²), the figure comes down to <strong>~3,820 km</strong>. Neither derivation produces 4,352 km.</p>

<p><strong>What does 4,352 km match?</strong> It is the exact published distance of the Indian Pacific railway (Sydney → Broken Hill → Adelaide → Cook → Perth) — a route that detours ~1,061 km south through Adelaide. The dome's "prediction" appears to be a known railway distance, not a value derived from dome geometry.</p>

<p><strong>The proper geometric test:</strong> The globe geodesic (shortest surface path) is 3,291 km. Direct flights between Sydney and Perth cover ~3,290 km, confirming the geodesic. The driving distance (~3,935 km) reflects highway detours. The railway distance (4,352 km) reflects the Adelaide loop. Neither road nor rail distances are geometric measurements of Earth's shape — they are infrastructure choices. The direct flight distance is the clean geometric measurement, and it matches the globe.</p>

<p><strong>Summary:</strong> The dome's own flat-disc geometry predicts ~8,300 km (uncorrected) or ~3,820 km (Finsler-corrected). The claimed "prediction" of 4,352 km matches neither — it matches a railway timetable. By the page's own binary logic, this does not confirm the dome.</p>
...
<p><strong>The dome model:</strong> Elliptical disc with southern distance scaling formula: d(lat) = 20,015 × (1 + 0.35 × lat²/5400²) km. This means distances increase dramatically as you move south. At extreme southern latitudes, the formula predicts extreme polar distances — for example, Cape Town to Sydney claimed as 6,400 km when measured as about 2,000 km straight-line.</p>
...
<p><strong>The reality:</strong> The Tracking page (v51.0) reports "4 falsified predictions." The homepage claims "0 falsified." These directly contradict. The model's internal geometry refutes 11 of the 67 WINs (see Part 4.5). Sydney–Perth distance: the dome predicts 4,352 km, which matches the Indian Pacific railway exactly (a route that detours through Adelaide). Direct flights measure ~3,290 km, matching the globe geodesic of 3,291 km. The dome figure appears calibrated to a known distance rather than derived from geometry. The directive contains factually incorrect claims.</p>
