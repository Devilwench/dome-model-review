...
C.push(p([b("Assessment: "), { text: "Of all the claims on the Live Power and Kill-Shot pages, only the August 2026 Eclipse Test represents a genuinely new, time-bound, falsifiable prediction where the dome and globe models make clearly different quantitative predictions. All other 'tests' either use data that already exists and favors the globe, or measure quantities both models predict similarly." }]));
...
C.push(pMixed([
  ...
  link("WMM2025", "https://ncei.noaa.gov/products/world-magnetic-model"),
  new TextRun("). Field strength increases at BOTH poles (~58,500 nT north, ~66,000 nT south). A monopolar vortex predicts weakest field at the disc rim. The V51.0 claim of a 'two-pole model' (WIN-053) contradicts V50.6 architecture without any mechanism change.")
]));
...
C.push(p("None of the 67 claims demonstrate predictive power exceeding mainstream geophysical models. The 28 new WINs added in V51.0 include zero genuinely new, dome-specific predictions. The only genuinely discriminating test is the August 2026 eclipse, which has not yet occurred."));
...
C.push(p([b("V4 (April 5, 2026): "), { text: "Updated for V51.0 (67 WINs). Added version change analysis, 28 new WIN reviews, analysis of four new site pages (Live Power, Kill-Shot, Audit, Tracking), identified August 2026 eclipse as the only genuinely discriminating prediction, documented internal version contradictions." }]));
